...
class ClientController extends Controller
{
    ...
    public function show_all($page = 1)
    {
...
//        return view('index',["clients"=>json_decode($enc,true)]);
        ...
        $data = DB::select("SELECT clients.id, clients.name_surname,clients.phone_num, clients.sex,clients.address, cars.brand, cars.car_number,cars.status_flag FROM
        clients JOIN cars on clients.id = cars.clients_id GROUP BY clients.id LIMIT $offset,$pagesize");
